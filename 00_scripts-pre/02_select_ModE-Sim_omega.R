...
results <- foreach ( i = 1:nrow(sets), .combine=rbind, .options.snow=opts) %dopar% {
  ...
  cdo.cmd <- with(sets[i,], paste0("cdo zonmean ",dir.data.ModEsim,Set,"/abs/",Memb,"/by_var/mon/ModE-Sim_",Set,"_",Memb,"_omega_50000_abs_",Per,"_mon.nc ",
...
cdo.cmd <- paste0("cdo zonmean ",dir.data.ModEsim,"set_1420-1_to_3/abs/ensstat/by_var/mon/ModE-Sim_set_1420-1_to_3_ensmean_omega_50000_abs_1420-1849_mon.nc ",
                  "ModE-Sim_set_1420-1_to_3_Omega500hPa-ZonMean_1420-1849_mon.nc")
system(cdo.cmd)

cdo.cmd <- paste0("cdo zonmean ",dir.data.ModEsim,"set_1850-1_to_2/abs/ensstat/by_var/mon/ModE-Sim_set_1850-1_to_2_ensmean_omega_50000_abs_1850-2009_mon.nc ",
...
for ( i in sets.names){
  ...
  cdo.cmd <- paste0("cdo zonmean ",dir.data.ModEsim, i,"/abs/ensstat/by_var/mon/ModE-Sim_",i,"_ensmean_omega_50000_abs_",epoch.years,"_mon.nc ",
                    "./",i,"/ModE-Sim_",i,"_ensmean_Omega500hPa-ZonMean_",epoch.years,"_mon.nc")
  system(cdo.cmd)
  
  # seasonal accumulation and selection
  cdo.cmd <- paste0("cdo seasmean ./",i,"/ModE-Sim_",i,"_ensmean_Omega500hPa-ZonMean_",epoch.years,"_mon.nc ./",i,"/ModE-Sim_",i,"_ensmean_Omega500hPa-ZonMean_",epoch.years,"_seasonal.nc")
  system(cdo.cmd)
  
  cdo.cmd <- paste0("cdo selseas,DJF ./",i,"/ModE-Sim_",i,"_ensmean_Omega500hPa-ZonMean_",epoch.years,"_seasonal.nc ./",i,"/ModE-Sim_",i,"_ensmean_Omega500hPa-ZonMean_",epoch.years,"_sDJF.nc")
  system(cdo.cmd)
  
  cdo.cmd <- paste0("cdo selseas,JJA ./",i,"/ModE-Sim_",i,"_ensmean_Omega500hPa-ZonMean_",epoch.years,"_seasonal.nc ./",i,"/ModE-Sim_",i,"_ensmean_Omega500hPa-ZonMean_",epoch.years,"_sJJA.nc")
  system(cdo.cmd)
}
