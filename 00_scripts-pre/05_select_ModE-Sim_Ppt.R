...
cdo.cmd <- "cdo seasmean ModE-Sim_set_1420-1_to_3_totprec-ZonMean_1420-1849_mon.nc ModE-Sim_set_1420-1_to_3_totprec-ZonMean_1420-1849_seasonal.nc"
system(cdo.cmd)
cdo.cmd <- "cdo selseas,DJF ModE-Sim_set_1420-1_to_3_totprec-ZonMean_1420-1849_seasonal.nc ModE-Sim_set_1420-1_to_3_totprec-ZonMean_1420-1849_sDJF.nc"
system(cdo.cmd)
cdo.cmd <- "cdo selseas,JJA ModE-Sim_set_1420-1_to_3_totprec-ZonMean_1420-1849_seasonal.nc ModE-Sim_set_1420-1_to_3_totprec-ZonMean_1420-1849_sJJA.nc"
system(cdo.cmd)

cdo.cmd <- "cdo seasmean ModE-Sim_set_1850-1_to_2_totprec-ZonMean_1850-2009_mon.nc ModE-Sim_set_1850-1_to_2_totprec-ZonMean_1850-2009_seasonal.nc"
system(cdo.cmd)
cdo.cmd <- "cdo selseas,DJF ModE-Sim_set_1850-1_to_2_totprec-ZonMean_1850-2009_seasonal.nc ModE-Sim_set_1850-1_to_2_totprec-ZonMean_1850-2009_sDJF.nc"
system(cdo.cmd)
cdo.cmd <- "cdo selseas,JJA ModE-Sim_set_1850-1_to_2_totprec-ZonMean_1850-2009_seasonal.nc ModE-Sim_set_1850-1_to_2_totprec-ZonMean_1850-2009_sJJA.nc"
system(cdo.cmd)
...
for ( i in sets.names){
  ...
  cdo.cmd <- paste0("cdo seasmean ./",i,"/ModE-Sim_",i,"_ensmean_totprec-ZonMean_",epoch.years,"_mon.nc ./",i,"/ModE-Sim_",i,"_ensmean_totprec-ZonMean_",epoch.years,"_seasonal.nc")
  system(cdo.cmd)
  
  cdo.cmd <- paste0("cdo selseas,DJF ./",i,"/ModE-Sim_",i,"_ensmean_totprec-ZonMean_",epoch.years,"_seasonal.nc ./",i,"/ModE-Sim_",i,"_ensmean_totprec-ZonMean_",epoch.years,"_sDJF.nc")
  system(cdo.cmd)
  
  cdo.cmd <- paste0("cdo selseas,JJA ./",i,"/ModE-Sim_",i,"_ensmean_totprec-ZonMean_",epoch.years,"_seasonal.nc ./",i,"/ModE-Sim_",i,"_ensmean_totprec-ZonMean_",epoch.years,"_sJJA.nc")
  system(cdo.cmd)
}
